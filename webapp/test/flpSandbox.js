		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UserData Demo",
									"targetURL": "#zalmzalmusersfiorifs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zalmzalmusersfiorifs-display": {
								"semanticObject": "zalmzalmusersfiorifs",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zalm.zalmusersfiorifs",
									"url": sap.ui.require.toUrl("zalm/zalmusersfiorifs")
								}
							}
						}
					}
